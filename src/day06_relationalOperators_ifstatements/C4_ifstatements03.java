...
public class C4_ifstatements03 {
	...
	public static void main(String[] args) {
		...
		char harf=scan.next().toLowerCase().charAt(0);// tek karakteri char olarak da alabilir 
		//ancak char primtivedir ve methodlarý yoktur
		//bunun icin string olarak almayý terich ettik
