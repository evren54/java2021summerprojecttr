...
public class C02_MethodCreation02 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		if (sayiAdedi<2) {
			...
			ikiSayiTopla();//sayarý metho ile almaya karar verdýk
		} else if (sayiAdedi==3) { 
			ucsayiTopla();
	}else if (sayiAdedi==4) { 
		dortsayiTopla();
	...
	public static void ikiSayiTopla() {// method ne aypacak return olacak mý
		// ethod ne yapacak return oalcak mý      void olmasýna karar verdýk ve 
		Scanner scan=new Scanner(System.in);
		System.out.println("lutfen iki tamsayi giriniz");
		int sayi1=scan.nextInt();
		int sayi2=scan.nextInt();
